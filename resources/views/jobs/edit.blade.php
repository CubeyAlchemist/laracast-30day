...
<form method="POST" action="/jobs/{{ $job->id }}">
    ...
    @csrf
    @method('PATCH') <!-- Indicates what type of method to route to outside of standard POST/GET -->
  ...
  <div class="mt-6 flex items-center justify-between gap-x-6"> <!-- Form Buttons -->
